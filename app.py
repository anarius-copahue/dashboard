...
def main():
    ...
    tableros = [
        ...
        {"tag": "Looker Studio", "t": "(WIP!) 📈 Venta Histórica", "d": "Data de Sell In/Out: Ventas por cliente y producto.", "url": "https://lookerstudio.google.com/reporting/6a2cec15-891e-410b-8ba5-d598b5437a3d", "color": "#7FA998", "bg": "#F1F7F4"},
    ]
